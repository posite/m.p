...
class MainActivity : AppCompatActivity() {
    ...
    inner class MyGalleryAdapter(internal var context: Context) : BaseAdapter() {
        ...
        var posterTitle=arrayOf("여인의 향기","쥬라기 공원","포레스트 검프","Groundhog Day",
        "혹성탈출 진화의 시작","아름다운 비행","내 이름은 칸","해리포터","마더","킹콩을 들다")
        override fun getView(p0: Int, p1: View?, p2: ViewGroup?): View {
            ...
            imageview.setOnTouchListener { v, event ->
                ...
                var toastText = toastView.findViewById<TextView>(R.id.tv1)
                toastText.setText(posterTitle[p0])
